...
- [ ] In the Heiti variants, the pinyin overlaps with next character pinyins. Make sure pinyin width do not exceed 98% hanzi width. You can compress pinyins horizontally to fit. But keep vertical heights consistent.
...
- [ ] Create a md file with sample text in Chinese (~20 chinese characters with 6 to 1 readings, in descending order) to show off these fonts capabilities; plus test text in English, then translated to Vietnamese,Russian, Greek, Malay. Each text is render to pdf in Sans then in Serif variant 1 to 6
